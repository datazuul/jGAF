...
public class UIUtils {
   ...
   * Clip a text.
   *
   * @param c the component used to clip the text. Width and FontMetrics from that component will be
   *     used for that purpose.
   * @param val the text to clip.
   * @param borderWidth width of the component border if any.
   * @return a clipped text terminating with three dots if the text does not fit within the
   *     component. Otherwise, the text remains unchanged.
   */
   ...
   * Clip a text.
   *
   * @param c the component used to clip the text. Width from that component will be used for that
   *     purpose.
   * @param fnt the Font to use to evaluate whether or not the text fits within the component. If
   *     null, Font is retrieved from the component.
   * @param val the text to clip.
   * @param xFrom starting x position within the component
   * @param xTo ending position within the component
   * @return a clipped text terminating with three dots if the text does not fit within xFrom and
   *     xTo. Otherwise, the text remains unchanged.
   */
  ...
  public static void setCpyAccelerator(Action act) {
    ...
    if (stroke != null) act.putValue(Action.ACCELERATOR_KEY, stroke);
  }
  ...
  public static RadioChooserEntry selectLoader(
      Component parent, String dlgHeader, List<RadioChooserEntry> entries) {

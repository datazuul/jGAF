...
public class ContextMenuElement {
  ...
  /**
   * Get the list of sub-items. Please note that this release of ContextMenuManager only handles one
   * level of sub-items.
   *
  ...
  /**
   * Set the list of sub-items. Please note that this release of ContextMenuManager only handles one
   * level of sub-items.
   *

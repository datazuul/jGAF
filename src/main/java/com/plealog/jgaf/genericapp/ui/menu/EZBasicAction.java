...
/**
 * Implementation of an AbstractAction for EZMenu system. In addition to the standard AbstractAction
 * capabilities, this action may have a user object and implements a default behavior for method
 * actionPerformed(): it fires a property change. The name of the property if the one returned by
 * this.getKeyName().
 */
public class EZBasicAction extends AbstractAction {
  ...
  /**
   * the key name of this action. This is that name that is used by DDActionManager to store this
   * Action in the ActionMap.
   */
  private String _name;
  /** figures out if this Action can be displayed in Menus for the current OS. */
  ...
  /**
   * Returns the key name of the action. This is that name that is used by EZActionManager to store
   * this Action in the ActionMap.
   */
  ...
  /**
   * Enable or disable this action. Default implementation disables this action if user object is
   * null.
   */
  public void update() {
    if (_usrObject == null) setEnabled(false);
  ...
  /** Sets whether or not this Action can be displayed in Menus for the current OS. */
  ...
  /**
   * Sends an update notification message to this action property change listeners. In the fired
   * event, property name is set to EZBasicAction.GLOBAL_UPDT_PROP, and both new and old values are
   * set to null.
   */
  ...
  /**
   * Implementation of AbstractAction method. This default implementation fires a property change
   * with property name sets to this.getKeyName(), old value sets to null and new value sets to
   * ActionEvent 'e'.
   */

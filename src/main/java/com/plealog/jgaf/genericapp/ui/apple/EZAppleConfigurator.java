package com.plealog.jgaf.genericapp.ui.apple;
...
/**
 * Utility class providing macOS desktop integration for both Java 8 and Java 9+ platforms.
 *
 * <p>Considering Java 8, this class uses legacy OSXAdapater class.
 *
 * <p>Considering Java 9+, this class relies upon new java.awt.Desktop APIs.
 *
 * <p>In other words, this class can be compiled using JDK 8 and used with JRE 8, 9, 11, etc.
 */
public class EZAppleConfigurator {
  ...
  // See https://docs.oracle.com/javase/9/migrate/toc.htm , section "Removed macOS-Specific
  // Features"
    ...
    if (_canUseOsxAdapter) {
      try {
        ...
        OSXAdapter.setQuitHandler(
            _singleton, _singleton.getClass().getDeclaredMethod("quit", (Class[]) null));
        OSXAdapter.setAboutHandler(
            _singleton, _singleton.getClass().getDeclaredMethod("about", (Class[]) null));
        OSXAdapter.setPreferencesHandler(
            _singleton, _singleton.getClass().getDeclaredMethod("preferences", (Class[]) null));
      ...
      try {
                ...
                new java.lang.reflect.InvocationHandler() {
                  ...
                  public Object invoke(Object proxy, java.lang.reflect.Method method, Object[] args)
                    ...
                    if (method_name.equals("handleAbout")) {
                      ...
                      EZEnvironment.getActionsManager()
                      ...
                      if (EZEnvironment.getActionsManager()
                          .getDefaultActionHandler()
                          .handleExit()) {
        ...
        method =
            clazz.getMethod(
                "setAboutHandler", new Class<?>[] {Class.forName("java.awt.desktop.AboutHandler")});
        ...
        method =
            clazz.getMethod(
                "setQuitHandler", new Class<?>[] {Class.forName("java.awt.desktop.QuitHandler")});
        method.invoke(deskTop, aboutHandler);
      } catch (Exception e) {
        if (_isDebugMode) {
          e.printStackTrace();

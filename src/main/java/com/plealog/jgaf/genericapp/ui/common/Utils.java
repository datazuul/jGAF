...
public class Utils {
  ...
  /**
   * Convert a number of bytes into a string suffixed with giga or mega or kilo. Resulting string is
   * added to a string buffer
   */
  ...
  /**
   * Append the file sourceFile to targetFile. String should be absolute paths to the files. Use

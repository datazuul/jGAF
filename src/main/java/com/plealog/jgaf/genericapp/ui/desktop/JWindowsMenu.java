...
/**
 * Based on the WindowManager class from the Zeus JCL library, This is a "Windows" menu to be
 * attached to a JMenuBar in an MDI application using JDesktopPane. The menu will have a selection
 * of the <code>MenuItem</code> functions listed such as Tile, Cascade, Minimize, Maximize, and
 * Restore. Also holds a set of check box menus that allow the user to choose different open
 * windows.
 */
public class JWindowsMenu extends JMenu implements ContainerListener {
  ...
  /**
   * The possible static menu items that can be added to the Windows menu above the dynamic listing
   * of open windows.
   */
  enum MenuItem {
  ...
  public JWindowsMenu(String windowTitle, JDesktopPane desktop) {
    this(
        ...
        MenuItem.MAXIMIZE,
        MenuItem.SEPARATOR,
        MenuItem.RESTORE_ALL,
        MenuItem.MINIMIZE_ALL,
        MenuItem.MAXIMIZE_ALL);
  }
  ...
  public JWindowsMenu(String windowTitle, JDesktopPane desktop, MenuItem... items) {
    ...
    this.frameComparator =
        new Comparator<JInternalFrame>() {
  ...
  private class CustomDesktopManager extends DefaultDesktopManager {
    ...
    public void deactivateFrame(JInternalFrame f) {
      if (f != null) super.deactivateFrame(f);
      updateStaticMenuItems();
    }
    ...
    public void deiconifyFrame(JInternalFrame f) {
      if (f != null) super.deiconifyFrame(f);
      updateStaticMenuItems();
    }
    ...
    public void iconifyFrame(JInternalFrame f) {
      if (f != null) super.iconifyFrame(f);
      updateStaticMenuItems();
    }
    ...
    public void maximizeFrame(JInternalFrame f) {
      if (f != null) super.maximizeFrame(f);
      updateStaticMenuItems();
    }
    ...
    public void minimizeFrame(JInternalFrame f) {
      if (f != null) super.minimizeFrame(f);
      updateStaticMenuItems();
    }
  }

  /**
   * Use this window positioner to position (<code>setLocation()</code>) of new windows added to the
   * desktop.
   *

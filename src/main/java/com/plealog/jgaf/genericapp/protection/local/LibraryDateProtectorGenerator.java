...
import com.plealog.jgaf.genericapp.protection.distrib.LibraryProtectorBase;
...
/**
 * This class is intended to control the validity of the library. It is used to copy a template
 * class into a concrete one where two strings are setup: the Date (YYYYmmdd, hexa encoded)
 * specifying when the library expired, and a hexa representation of the date hashcode. The second
 * one is used to check any attempt to alter the date.
 *
 * <p>DO NOT distribute this class with the library.
 */
public class LibraryDateProtectorGenerator {
  /**
   * @param fTemplate it is the absolute path to LibraryProtectorController.template contained in
   *     this package
   * @param fClass it is the absolute path LibraryProtectorController.class contained in
   *     protection.distrib package
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Generate LibraryTimeStamp: convert '" + args[0] + "' to '" + args[1] + "'.");

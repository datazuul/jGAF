...
public final class LicenseKeyController {
   ...
   */
  public static final String generate(String valueToEncode) {
    char[] charArray;
  ...
  private static final byte[] getHash(byte[] toHash) throws Exception {
    MessageDigest digest = MessageDigest.getInstance(ALGO);
    digest.reset();
    return digest.digest(toHash);
  }

  private static final String Encode(char[] charArray, byte[] data) {
    String ret = "";

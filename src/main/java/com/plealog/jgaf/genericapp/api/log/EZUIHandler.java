...
import com.plealog.jgaf.genericapp.api.log.EZLoggerManager.LogLevel;
import com.plealog.jgaf.genericapp.ui.common.ClipBoardTextTransfer;
...
/**
 * Utility class serving as a gateway between logger handler and UI component. For internal use
 * only.
 */
    ...
    SwingUtilities.invokeLater(
        new Runnable() {
          ...
          public void run() {
            ...
            try {
              doc.insertString(doc.getLength(), getFormatter().format(record), style);

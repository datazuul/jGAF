...
public class EZFileFilter extends javax.swing.filechooser.FileFilter
  ...
  /**
   * Creates a file filter that accepts the given file type. Example: new EZFileFilter("jpg", "JPEG
   * Image Images");
   *
  ...
  /**
   * Creates a file filter from the given string array. Example: new EZFileFilter(String {"gif",
   * "jpg"});
   *
   ...
   * EZFileFilter(String {"gif", "jpg"}, "Gif and JPG Images");
   *
   * <p>Note that the "." before the extension is not needed and will be ignored.
   */
  ...
  /**
   * Returns true if this file should be shown in the directory panel, false if it should not be
   * shown.
   *
  ...
  /**
   * Figures out whether or not the extension list (.jpg, .gif, etc) should show up in the
   * description.
   *

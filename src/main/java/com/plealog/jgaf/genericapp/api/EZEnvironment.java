...
import com.plealog.jgaf.genericapp.api.persistense.PrefSafeBox;
...
public class EZEnvironment {
  ...
  public static final String[] OS_NAMES = {"windows", "macos", "linux", "other"};
  ...
  /**
   * Returns an image given a key. Images are usually contains within a resource package. Please
   * refer to {@link EZEnvironment#addResourceLocator(Class)} methods.
   *
   * @param key image key.
   */
  ...
  /**
   * Sets the application main frame. For internal use only: this method is automatically called by
   * the Generic Application Framework when creating the application main frame.
   */
  ...
  /**
   * Sets the application command-line arguments. For internal use only: this method is
   * automatically called by the Generic Application Framework at startup.
   */
   ...
   *
   * @param parent parent of this dialogue box. Either another dialogue box or the main frame.
   *     Passing null is authorized; in that case, the main frame is considered as the parent of the
   *     dialogue box.
   * @param msg message
   * @param initValue initial value displayed in the dialogue box
   ...
   * Default is true. Usually this method is called when implementing {@link
   * EZDefaultActionHandler#handleExit()} method.
   */

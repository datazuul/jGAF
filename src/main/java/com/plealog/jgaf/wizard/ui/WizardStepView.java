...
public abstract class WizardStepView {
  ...
  /**
   * Method called by the WizardDialog to figures out whether or not it can disable Wizard scroll
   * panel. This can happen when this View provides its own scroll panel.
   */

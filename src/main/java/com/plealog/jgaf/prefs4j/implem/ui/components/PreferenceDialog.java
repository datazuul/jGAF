...
public class PreferenceDialog extends JDialog {
  ...
  public PreferenceDialog(
      Frame owner, String title, PreferenceModel model, Set<PreferenceEditor.PROPERTY> props) {
  ...
  public PreferenceDialog(
    ...
    super(owner, title == null ? DEFAULT_TITLE : title, true);
    _width = dlgWidth;
    _height = dlgHeight;
    if (title != null) _title = title;
    buildGUI(model, props);
    this.setPreferredSize(
        new Dimension(PreferencePanel.DEFAULT_WIDTH, PreferencePanel.DEFAULT_HEIGHT));
    this.pack();
  ...
  private void buildGUI(PreferenceModel model, Set<PreferenceEditor.PROPERTY> props) {
    JPanel mainPanel, btnPanel, footerPanel, okPanel;
    JButton ok, cancel;
    Border eBorder;
    boolean macos;
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        ...
        JOptionPane.showMessageDialog(
            ...
            EZEnvironment.getMessage("__EZConfDlf.err.saveData") + ": " + ex.getMessage(),
            _title,

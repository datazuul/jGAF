...
public class PatternSearchFacility {
  ...
  private class SearchButtonActionListener extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      try {
        _txtC.getHighlighter().removeAllHighlights();
        _txtC.getHighlighter().addHighlight(start, end, DefaultHighlighter.DefaultPainter);
  ...
  public SearchField getSearchForm() {
    ...
    _search =
        _sf.addUserAction(EZEnvironment.getImageIcon("run.png"), new SearchButtonActionListener());
    _sf.addPropertyChangeListener(
        SearchField.PROPERTY_TEXT,

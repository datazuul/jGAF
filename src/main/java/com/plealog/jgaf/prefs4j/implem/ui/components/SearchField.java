...
public class SearchField extends JPanel {
  private static final long serialVersionUID = 8931639744894175005L;
  ...
  public JButton addUserAction(ImageIcon icon, Action act) {
    ...
    btn.setVisible(true);
    _commandPnl.add(btn, BorderLayout.WEST);
    return btn;
  }
  ...
  public Font getFont() {
    return _textField != null && _textField.getFont() != null
        ? _textField.getFont()
        : super.getFont();
  }
  ...
  private MouseListener optionListener =
      new MouseAdapter() {
  ...
  private class MyTextField extends JTextField {
    public void paintComponent(Graphics g) {
      ...
      if (_helper == null || txt == null || txt.length() != 0) return;

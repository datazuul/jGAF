...
/**
 * This class implements a GUI container for Item. In other words, if considering the
 * Model-View-Controller paradigm, ItemGUIContainer is the view part of an Item, the last being the
 * model. Note that ItemGUIContainer is not a GUI component itself but it wraps such a component.
 */
public class ItemGUIContainer {
  ...
  /**
   * Returns the combo-box associated to this ItemGUIContainer. Such a combo-box is defined if Item
   * is a Choice, otherwise this method returns null.
   */
  ...
  /**
   * Returns the text-field associated to this ItemGUIContainer. Such a text-field is defined if
   * Item is a Value, otherwise this method returns null.
   */
  public JTextField getTxtField() {
    return _txt;
  }
  /**
   * Returns the checkbox-field associated to this ItemGUIContainer. Such a checkbox-field is
   * defined if Item is a Value of type Boolean, otherwise this method returns null.
   */
  ...
  /**
   * Returns the spinner associated to this ItemGUIContainer. Such a spinner is defined if Item is a
   * Value defined with a Range, otherwise this method returns null.
   */
  ...
  public void setSpinner(JSpinner spinner) {
    if (this._spinner != null) {
      ((JSpinner.DefaultEditor) this._spinner.getEditor())
          .getTextField()
          .getDocument()
          .removeDocumentListener(_editListener);
    }
    this._spinner = spinner;
    ((JSpinner.DefaultEditor) this._spinner.getEditor())
        .getTextField()
        .getDocument()
        .addDocumentListener(_editListener);
  }
  /**
  ...
  /**
   * Returns the name of this container. The returned name is actually the one of the Item
   * associated to this ItemGUIContainer.
   */
  ...
  /** Returns the value associated to the GUI component wrapped by this ItemGUIContainer. */
  public String getValue() {
    ...
    switch (_type) {
      ...
      case COMBO_TYPE:
        ...
        if (val.equals("do_not_use")) val = null;
        break;
      case SPINNER_TYPE:
        ...
        try {
          ...
          else if (_item.getDtype() == Item.DTYPE_REAL) val = Double.valueOf(val).toString();
  ...
  /**
   * Returns the GUI component wrapped by this ItemGUIContainer. Such a component is either a
   * JComboBox or a JTextField or a JSpinner.
   */

...
/**
 * This class implements a basic text editor. It provides a toolbar (undo/redo and cut/copy/paste
 * actions) as well as a text-based search facility.
 *
...
public class SimpleTextEditor extends JPanel {
  ...
  /** Retrieves an action given its name. Call this method after a call to createActionTable. */
